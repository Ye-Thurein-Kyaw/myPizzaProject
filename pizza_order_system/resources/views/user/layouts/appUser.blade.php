        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex justify-content-between">
            <div class="col-lg-4 ">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-warning bg-dark px-2">MYOMA</span>
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg bg-dark navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-warning bg-dark px-2">MyoMa</span>
                        <span class="h1 text-uppercase bg-warning text-dark px-2 ml-n1">Shop</span>
                    </a>
                    <button type="button" class="navbar-toggler  text-warning" data-toggle="collapse" data-target="#navbarCollapse">
                        <span class="navbar-toggler-icon text-warning"></span>
                    </button>
                    <div class="collapse navbar-collapse justify-content-between text-warning" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{route('user#home')}}" class="nav-item text-warning nav-link active">Home</a>
                            <a href="cart.html" class="nav-item text-warning nav-link">My Cart</a>
                            <a href="contact.html" class="nav-item text-warning nav-link">Contact</a>

                        </div>
                        <div class="navbar-nav ml-auto py-0  d-lg-block me-4">
                            ...
                            <div class="dropdown">
                                <a class="btn btn-dark text-warning dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-user text-warning"></i> {{Auth::user()->name}} <i class="fa-solid fa-caret-down text-warning"></i>
                                </a>

                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="{{ route('user#accountChangePage')}}"><i class="fa-regular fa-file-user"></i> Account</a></li>
                                  <li><a class="dropdown-item" href="{{route('user#changePasswordPage')}}">Change Password</a></li>
                                  <li><div class="dropdown-item">

                                    <form action="{{route('logout')}}" class=" justify-content-center" method="POST">
                                        @csrf
                                        <button class="btn bg-dark text-warning mt-2">
                                            Logout <i class="fa-sharp fa-solid fa-arrow-right-from-bracket ms-2"></i>
                                        </button>
                                    </form>
                                        </div>
                                   </li>
